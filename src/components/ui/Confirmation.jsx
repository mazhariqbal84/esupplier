...
import { setactiveModal, setdeleteConfrim, setDeleteAll } from "@/store/services/common/confirmation.module";
const Confirmation = ({
  onClose,
  noFade,
  disableBackdrop,
  ...
  const { activeModal } = useSelector((state) => state.confirmation);
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`px-6 ${scrollContent ? "overflow-y-auto max-h-[400px]" : ""
                      }`}
                  >
                    {children}
                  </div>
                  {footerContent && (
                    <div className="px-4 py-3 flex justify-between space-x-3 border-t border-slate-100 dark:border-slate-700">
